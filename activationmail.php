...
function mailed($email, $username, $name, $token)
{
                        ...
                        <tr>
                            <td align="center"
                                ...
                                <div style="line-height: 35px">
                                    ...
                                    Welcome to ultimate shoping<span style="color: #5caad2;"> experience</span>
                                                ...
                                                <tr>
                                                    <td align="center"
                                                        ...
                                                        <div style="line-height: 22px;">
                                                            <a href="http://localhost/trivor/activate.php?token=' . $token . '" style="color: #ffffff; text-decoration: none;">ACTIVATE NOW</a>
                                                        </div>
                                                    </td>
                                                </tr>
    ...
    http://localhost/trivor/activate.php?token=' . $token . '';
