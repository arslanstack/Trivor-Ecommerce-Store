...
if (isset($_POST['rasta'])) {
    ...
    header("Location: edsale.php");
    exit();
}
if (isset($_POST['wasta'])) {
    $_SESSION['delee'] = $_POST['wasta'];
    $_SESSION['amount'] = $_POST['pasta'];
            ...
            <div class="row">
                <div class="col" id="contains">
                    ...
                    <div class="">
                        ...
                        <a href="stats.php" class="btn btn-success" style="float: right"><i class="fa fa-eye"></i> View Stats</a>
                    </div>
                    <br><br>
                    <table id="prod_table" class="table table-striped">
                        ...
                        <tbody>';
                            ...
                            $sql = "SELECT * FROM sales WHERE status NOT LIKE 'processing'";
                            if ($result = mysqli_query($conn, $sql)) {
                                if (mysqli_num_rows($result) > 0) {
                                    ...
                                    while ($row = mysqli_fetch_array($result)) {
                                        ...
                                        <td>
                                        <form action="" method = "post"> <input class="d-none" name="rasta" value = "' . $row['orderno'] . '"> <button type="submit" style="border: none;" id="editing"><i class="fa fa-check" aria-hidden="true"></i></button></form>
                                       
                                        </td>
                                        <td>
                                        <form action="" method = "post"> <input class="d-none" name="wasta" value = "' . $row['orderno'] . '"><input class="d-none" name="pasta" value = "' . $row['amount'] . '"> <button type="submit" style="border: none;" id="deleting"><i class="fa fa-eye" aria-hidden="true"></i></button></form>
