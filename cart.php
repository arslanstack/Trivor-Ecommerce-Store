...
if (isset($_POST['deletedTwo'])) {
    $delee = $_POST['deletedTwo'];
    require_once "./../trivor/config.php";
    $sql = "DELETE FROM cartproduct WHERE username = '{$_SESSION['userid']}' AND prodid = '{$delee}'";
...
if (isset($_POST['quantityTwo'])) {
    $productid = $_POST['productTwo'];
    $quantity = $_POST['quantityTwo'];
    require_once "./../trivor/config.php";
    $sql = "UPDATE cartproduct SET quantity = '{$quantity}' WHERE username = '{$_SESSION['userid']}' AND prodid = '{$productid}'";
    if ($result = mysqli_query($conn, $sql)) {
...
<head>
    ...
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
    <!-- Font Awesome -->
    <script src="https://kit.fontawesome.com/1ad9216c1c.js" crossorigin="anonymous"></script>
    <!-- Bootstrap CSS -->
                                            ...
                                            <div class="col-lg-8">
                                                <div class="p-5">
                                                    ...
                                                    if (!$_SESSION['userid']) {
                                                                ...
                                                                if ($result = mysqli_query($conn, $sql)) {
                                                                    if (mysqli_num_rows($result) > 0) {
                                                                        ...
                                                                        <div class="col-md-2 col-lg-2 col-xl-2">
                                                                            <img src="' . substr_replace($img, 'trivor/', 5, 0) . '"
                                                                        ...
                                                                        <div class="col-md-3 col-lg-3 col-xl-2 d-flex">
                                                                            ...
                                                                            <input min="1" name="quantity" value="' . $quantity . '" type="number" onkeyup="document.getElementById("submitter").click()" class="form-control form-control-sm" />
                                                                            <input class="d-none" name = "product" value = "' . $key . '">
                                                                            <button type="submit" class="d-none" id="submitter"></button>
                                                                            </form>
                                                                        </div>
                                                                        <div class="col-md-3 col-lg-2 col-xl-2 offset-lg-1">
                                                                            <h6 class="mb-0">$ ' . $price * $quantity . '</h6>
                                                                        </div>
                                                                        <div class="col-md-1 col-lg-1 col-xl-1 text-end">
                                                                        <form action="" method = "post">
                                                                        <input class = "d-none" name = "deleted" value = "' . $prodid . '">
                                                                        <button type="submit" style = "background-color: none; border: none;"><i class="fas fa-times"></i></button>
                                                                    </form>
                                                                        </div>
                                                                    </div>
                                                                    <hr class="my-4">';
                                                        ...
                                                        $sql = "SELECT * FROM cartproduct WHERE username = '{$username}'";
                                                        if ($result = mysqli_query($conn, $sql)) {
                                                            if (mysqli_num_rows($result) > 0) {
                                                                while ($row = mysqli_fetch_array($result)) {
                                                                    ...
                                                                    class="row mb-4 d-flex justify-content-between align-items-center">
                                                                    <div class="col-md-2 col-lg-2 col-xl-2">
                                                                        <img src="' . substr_replace($row['img'], 'trivor/', 5, 0) . '"
                                                                            class="img-fluid rounded-3" alt="Cotton T-shirt">
                                                                    </div>
                                                                    <div class="col-md-3 col-lg-3 col-xl-3">
                                                                    ...
                                                                    <div class="col-md-3 col-lg-3 col-xl-2 d-flex">
                                                                        ...
                                                                        <form action="" method = "post">
                                                                        <input min="1" name="quantityTwo" value="' . $row['quantity'] . '" type="number" onkeyup ="document.getElementById("submitter").click()" class="form-control form-control-sm" />
                                                                        <input class="d-none" name = "productTwo" value = "' . $row['prodid'] . '">
                                                                        <button type="submit" class="d-none" id="submitter"></button>
                                                                        </form>
                                                                    </div>
                                                                    <div class="col-md-3 col-lg-2 col-xl-2 offset-lg-1">
                                                                        <h6 class="mb-0">$ ' . $row['price'] * $row['quantity'] . '</h6>
                                                                    </div>
                                                                    <div class="col-md-1 col-lg-1 col-xl-1 text-end">
                                                                    <form action="" method = "post">
                                                                    <input class = "d-none" name = "deletedTwo" value = "' . $row['prodid'] . '">
                                                                    <button type="submit" style = "background-color: none; border: none;"><i class="fas fa-times"></i></button>
                                                                </form>
                                                                    </div>
                                                                </div>
                                                    ...
                                                    <div class="pt-5">
                                                        <h6 class="mb-0"><a href="shop.php" class="text-body"><i class="fas fa-long-arrow-alt-left me-2"></i> Go To Shop</a></h6>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-lg-4 bg-grey">
                                                <div class="p-5">
                                                    ...
                                                    <div class="d-flex justify-content-between mb-4">
                                                        ...
                                                        <h5 class="text-uppercase"><?php echo $count ?></h5>
                                                    </div>
                                                    ...
                                                    <button type="button" <?php if ($count == 0) {
                                                                                echo 'disabled';
                                                                            } ?> onclick="location.href='proceed.php';" class="btn btn-dark btn-block btn-lg" data-mdb-ripple-color="dark">Proceed</button>
