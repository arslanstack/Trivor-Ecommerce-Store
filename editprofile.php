...
if ($_SESSION['sessionuser'] == true && (time() - $_SESSION['logintimeuser'] < 7200)) {
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if (empty($pswdup)) {
            $sql = "UPDATE userdata SET name = '{$nameups}', email = '{$emailups}', phone = '{$phoneups}' WHERE username = '{$username}'";
            ...
            $sql = "UPDATE userdata SET name = '{$nameups}', email = '{$emailups}', phone = '{$phoneups}', pswd = '{$pswdups}' WHERE username = '{$username}'";
                        ...
                        <div class="col-md-8 border-right">
                            <div class="p-3 py-5">
                                ...
                                <div class="row mt-2">
                                    ...
                                    <div class="col-md-6"><label class="labels">Password</label><input type="password" class="form-control" value="" name="pswd" placeholder="*********"></div>
                                </div>
                                <div class="row mt-3">
