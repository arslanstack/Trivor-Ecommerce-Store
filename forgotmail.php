...
function mailed($email, $username, $name, $token)
{
    ...
    try {
        ...
        $mail->Subject = 'Reset Password ' . $name . ' - Gain access to your Account';
                        ...
                        <tr>
                            <td align="center"
                                ...
                                <div style="line-height: 35px">
                                    ...
                                    Your account has been <span style="color: #5caad2;">put on hold</span>
                                                ...
                                                <tr>
                                                    <td align="center"
                                                        ...
                                                        <div style="line-height: 22px;">
                                                            <a href="http://localhost/trivor/reset.php?token=' . $token . '" style="color: #ffffff; text-decoration: none;">RESET NOW</a>
                                                        </div>
                                                    </td>
                                                </tr>
    ...
    http://localhost/trivor/reset.php?token=' . $token . '';
