...
<body>
        ...
        <div class="container mx-auto">
            <div class="row">
                <div class="col-md-6" id="jumbo">
                    <h4 class="display-5" id="brown">Trade-in-offer</h6>
                        <h1 class="display-4">
                            <span id="black">Super value deals</span> <br>
                            <span id="green">On all products</span>
                        </h1>
                        <p class="lead">Save more with coupons & upto 70% off!</p>
    ...
    <section class="container" id="sec2">
        <div class="row">
            <div class="col-lg-12">
                <h2 class="display-4 text-center" id="sec2head"> Featured Products</h2>
        ...
        <div class="row">
            <div class="col-lg-3">
                <a href="shop.php" style="text-decoration: none; color: black;">
                    <div class="card my-2" id="card1">
                        <img class="card-img-top" src="assets/imgs/products/f4.jpg" Card image cap">
                        <div class="card-body">
                            <h6 class="card-subtitle mb-2 text-muted">addidas</h6>
                            <h5 class="card-title">Austronaut T-Shirt</h5>
                            <div class="cardbtm">
                                <h5 class="" id="price">$75</h5>
                                <a class="" id="bucket" href="shop.php"><svg width="40" height="40" fill="none" stroke="black"
            ...
            <div class="col-lg-3">
                <a href="shop.php" style="text-decoration: none; color: black;">
                    <div class="card my-2" id="card1">
                        <img class="card-img-top" src="assets/imgs/products/f3.jpg" Card image cap">
                        <div class="card-body">
                            <h6 class="card-subtitle mb-2 text-muted">addidas</h6>
                            <h5 class="card-title">Austronaut T-Shirt</h5>
                            <div class="cardbtm">
            ...
            <div class="col-lg-3">
                <a href="shop.php" style="text-decoration: none; color: black;">
                    <div class="card my-2" id="card1">
                        <img class="card-img-top" src="assets/imgs/products/f2.jpg" Card image cap">
                        <div class="card-body">
                            <h6 class="card-subtitle mb-2 text-muted">addidas</h6>
                            <h5 class="card-title">Austronaut T-Shirt</h5>
                            <div class="cardbtm">
            ...
            <div class="col-lg-3">
                <a href="shop.php" style="text-decoration: none; color: black;">
                    <div class="card my-2" id="card1">
                        <img class="card-img-top" src="assets/imgs/products/f1.jpg" Card image cap">
                        <div class="card-body">
                            <h6 class="card-subtitle mb-2 text-muted">addidas</h6>
                            <h5 class="card-title">Austronaut T-Shirt</h5>
                            <div class="cardbtm">
    ...
    <section class="container-fluid" id="banner1">
        <div class="materialbanner1">
            <h2 class="display-4 text-center text-white" style="font-family: 'Pacifico', cursive; font-weight: 400;">
                Talk of the Town</h2>
            <br>
            <a href="shop.php" class="btn btn-light" id="banner1btn">Explore More</a>
        </div>
    </section>
    <section class="container" id="sec2">
        <div class="row">
        ...
        <div class="row">
            <div class="col-lg-3">
                <a href="shop.php" style="text-decoration: none; color: black;">
                    <div class="card my-2" id="card1">
                        <img class="card-img-top" src="assets/imgs/products/n1.jpg" Card image cap">
                        <div class="card-body">
                            <h6 class="card-subtitle mb-2 text-muted">addidas</h6>
                            <h5 class="card-title">Austronaut T-Shirt</h5>
                            <div class="cardbtm">
            ...
            <div class="col-lg-3">
                <a href="shop.php" style="text-decoration: none; color: black;">
                    <div class="card my-2" id="card1">
                        <img class="card-img-top" src="assets/imgs/products/n2.jpg" Card image cap">
                        <div class="card-body">
                            <h6 class="card-subtitle mb-2 text-muted">addidas</h6>
                            <h5 class="card-title">Austronaut T-Shirt</h5>
                            <div class="cardbtm">
            ...
            <div class="col-lg-3">
                <a href="shop.php" style="text-decoration: none; color: black;">
                    <div class="card my-2" id="card1">
                        <img class="card-img-top" src="assets/imgs/products/n3.jpg" Card image cap">
                        <div class="card-body">
                            <h6 class="card-subtitle mb-2 text-muted">addidas</h6>
                            <h5 class="card-title">Austronaut T-Shirt</h5>
                            <div class="cardbtm">
            ...
            <div class="col-lg-3">
                <a href="shop.php" style="text-decoration: none; color: black;">
                    <div class="card my-2" id="card1">
                        <img class="card-img-top" src="assets/imgs/products/n4.jpg" Card image cap">
                        <div class="card-body">
                            <h6 class="card-subtitle mb-2 text-muted">addidas</h6>
                            <h5 class="card-title">Austronaut T-Shirt</h5>
                            <div class="cardbtm">
    ...
    <section class="container mx-auto">
        <div class="row" id="boxing">
            <div class="col-md-6" id="box1">
                <div id="materialbox">
                    <h4 class="beginner">crazy deals</h6>
                        <h1 class="mainer">buy 1 get 1 free</h1>
                        <p class="para">The best classic dress is on sale at cara</p>
                        <a href="shop.php" class="btn btn-outline-light" id="btner">More Details</a>
                </div>
            </div>
            <div class="col-md-6" id="box2">
                <div id="materialbox">
                    <h4 class="beginner">spring/summer</h6>
                        <h1 class="mainer">Upcoming Seasons</h1>
                        <p class="para">The best classic dress is on sale at cara</p>
                        <a href="shop.php" class="btn btn-oprimary" id="btner2">More Details</a>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="container-fluid text-center text-md-left">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mt-md-0 mt-3" id="paragraph1">
                        ...
                        <div class="row">
                            <svg width="25" height="25" fill="black" style="margin-right: 8px;" viewBox="0 0 24 24"
