...
$sql = "SELECT * FROM userdata WHERE username = '{$_SESSION['editee']}'";
...
$sql = "UPDATE userdata SET name = '{$nameups}', username = '{$usernameups}', email = '{$emailups}', phone = '{$phoneups}', status = '{$statusups}' WHERE username = '{$username}'";
