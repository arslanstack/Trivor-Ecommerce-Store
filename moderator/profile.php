...
$sql = "SELECT * FROM moderator WHERE username = '{$_SESSION['modid']}'";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($pswdup)) {
        $sql = "UPDATE moderator SET name = '{$nameups}', email = '{$emailups}', phone = '{$phoneups}' WHERE username = '{$username}'";
        ...
        $sql = "UPDATE moderator SET name = '{$nameups}', email = '{$emailups}', phone = '{$phoneups}', pswd = '{$pswdups}' WHERE username = '{$username}'";
...
if ($_SESSION['sessionmod'] == true && (time() - $_SESSION['logintimemod'] < 1800)) {
