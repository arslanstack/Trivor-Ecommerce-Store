...
<body>
    <section class="container-fluid topsection">
        <nav class="navbar navbar-expand-lg navbar-light" id="topnav">
            <a class="navbar-brand pt-0" id="brand" href="index.php"><img src="assets/imgs/logo.png" alt=""></a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto">
                    <li class="nav-item active">
                        <a class="nav-link" style="font-weight: 700;" href="profile.php">PROFILE <span class="sr-only">(current)</span></a>
                    </li>
                    <li class="nav-item active">
                        <a class="nav-link" style="font-weight: 700;" href="shop.php">SHOP<span class="sr-only">(current)</span></a>
                    </li>
                    <li class="nav-item active">
                        <a class="nav-link" style="font-weight: 700;" href="orders.php">ORDERS<span class="sr-only">(current)</span></a>
                    </li>
                ...
                <form class="form-inline my-2 my-lg-0">
                    <ul class="navbar-nav mr-auto">
                        ...
                        <li class="nav-item active">
                            <a class="nav-link" style="font-weight: 700;" href="editprofile.php">SETTINGS<span class="sr-only">(current)</span></a>
                        </li>
                        <li class="nav-item active">
    ...
    <div class="container mx-auto px-0">
        <div class="row">
            <h2 class="display-6" style="margin-left: 30px;">Active Orders</h2>
            <br>
            <br><br>
            <br>
            <div class="col-md-12">
                ...
                $sqla = "SELECT * FROM sales  WHERE username = '{$_SESSION['userid']}' AND status = 'completed' ORDER BY orderno DESC";
                if ($resulta = mysqli_query($conn, $sqla)) {
                    if (mysqli_num_rows($resulta) > 0) {
                        ...
                        while ($rowa = mysqli_fetch_array($resulta)) {
                            ...
                            $totalamount = $rowa['amount'];
                            echo '<section class="">
                                <div class="col-lg-12">
                                    <div class="card " style="border-color: #f37a27 !important;">
                                        <div class="card-body">
            
                                            <p class="lead fw-bold mb-5" style="color: #f37a27;">On Your Way</p>
                            ...
                            $sql = "SELECT * FROM orders  WHERE orderid = '{$orderno}'";
                            if ($result = mysqli_query($conn, $sql)) {
                                if (mysqli_num_rows($result) > 0) {
                                    while ($row = mysqli_fetch_array($result)) {
                                        $prodid = $row['prodid'];
                                        $quantity = $row['quantity'];
                                        $thingamount = $row['amount'];
                                        $name = $row['name'];
                                        $price = $row['price'];
                                        echo '<div class="mx-n5 px-5 py-4" style="background-color: #f2f2f2;">
                                                        <div class="row">
                                ...
                                echo "Error orders table data order no    : " . $sql . "<br>" . mysqli_error($conn);
                            }
                            echo ' 
                                            <div class="row my-4">
                                                    <div class="col-md-4 offset-md-8 col-lg-3 offset-lg-9">
                                                        <p class="lead fw-bold mb-0" style="color: #f37a27;"> Total:  $' . $totalamount . '</p>
                                                    </div>
                                                </div>
                                        </div>
                                    </div>
        ...
        <br>
        <div class="row">
            <h2 class="display-6" style="margin-left: 30px;">Previous Order History</h2>
            <br>
            <br><br>
            <br>
            <div class="col-md-12">
                <?php
                require_once "config.php";
                $sqla = "SELECT * FROM sales  WHERE username = '{$_SESSION['userid']}' AND status = 'delivered' ORDER BY orderno DESC";
                if ($resulta = mysqli_query($conn, $sqla)) {
                    if (mysqli_num_rows($resulta) > 0) {
                        $count = 0;
                        while ($rowa = mysqli_fetch_array($resulta)) {
                                ...
                                <div class="col-lg-12">
                                    <div class="card " style="border-color: #f37a27 !important;">
                                        <div class="card-body">
                                            ...
                                            <p class="lead fw-bold mb-5" style="color: #f37a27;">Delivered</p>
