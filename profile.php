...
if ($_SESSION['sessionuser'] == true && (time() - $_SESSION['logintimeuser'] < 7200)) {
    ...
    $sql = "SELECT * FROM userdata WHERE username = '{$_SESSION['userid']}'";
            ...
            <nav class="navbar navbar-expand-lg navbar-light" id="topnav">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <form class="form-inline my-2 my-lg-0">
                        ...
                        <li class="nav-item active">
                        <a class="nav-link" href="editprofile.php">SETTINGS<span class="sr-only">(current)</span></a>
                    </li>
                            <li class="nav-item active">
                                <a class="nav-link"'; if ($_SESSION['userid']) {
                                                        echo "href=./logout.php>LOGOUT";
                                                    } else {
                                                        echo "href=./signup.php>SIGNUP ";
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8 border-right">
                            <div class="p-3 py-5">
                                ...
                                <div class="row mt-2">
                                    <div class="col-md-6"><label class="labels">Username</label><input type="text" class="form-control" name="username" value="' . $username . '" readonly></div>
                                    <div class="col-md-6"><label class="labels">Password</label><input type="password" class="form-control" value="" name="pswd" placeholder="*********" readonly></div>
                                </div>
                                <div class="row mt-3">
                                    <div class="col-md-12"><label class="labels">Full Name</label><input type="text" class="form-control" name="name" value="' . $name . '" readonly></div>
                                    <div class="col-md-12"><label class="labels">Email</label><input type="text" class="form-control" name="email" value="' . $email . '" readonly></div>
                                    <div class="col-md-12"><label class="labels">Phone</label><input type="text" class="form-control" name="phone" value="' . $phone . '" readonly></div>
                                </div>
                                <div class="mt-5 text-center"><a class="btn btn-primary profile-button" href = "editprofile.php">Edit Profile</a></div>
                            </div>
                        </div>
                    </div>
                </div>
